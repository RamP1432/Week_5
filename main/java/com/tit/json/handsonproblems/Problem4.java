...
public class Problem4 {
    ...
    public static void main(String[] args) {
        ...
        try (InputStream schemaStream = Problem4.class.getResourceAsStream("/JSONFileH4S.json")) {
            ...
            try (InputStream dataStream = Problem4.class.getResourceAsStream("/JSONFile4.json")) {
                if (dataStream == null) {
